...
with st.sidebar:
    st.markdown("## 👨‍🎓 Pelajar")
    st.page_link("pages/login_pelajar.py", label="🔑 Login Pelajar")
    ...
    st.page_link("pages/login_penyelia_akademik.py", label="🔑 Login Penyelia Akademik")
    ...
    st.page_link("pages/login_penyelia_industri.py", label="🔑 Login Penyelia Industri")
    ...
    st.page_link("pages/login_penyelaras.py", label="🔑 Login Penyelaras")
